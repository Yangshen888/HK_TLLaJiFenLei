...
namespace HaikanRefuseClassification.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        ///// 
        ///// </summary>
        //public Microsoft.EntityFrameworkCore.DbQuery<SystemPermissionWithAssignProperty> SystemPermissionWithAssignProperty { get; set; }
        ///// <summary>
        ///// 
        ///// </summary>
        //public System.Data.Entity.Infrastructure.DbQuery<SystemPermissionWithMenu> SystemPermissionWithMenu { get; set; }
        //#endregion
        /// <summary>
        /// 
        /// </summary>
...
//WHERE P.IsDeleted=0 AND P.Status=1 AND EXISTS (SELECT 1 FROM SystemUserRoleMapping AS URM WHERE URM.SystemUserUUID={0} AND URM.SystemRoleUUID=RPM.SystemRoleUUID)";
                ...
                response.SetData(new
                {
                    ...
                    user_vuid = user.VillageId,
                    user_streets = user.Streets,
                    user_community = user.Community,
                    user_biotope = user.Biotope,
...
//WHERE P.IsDeleted=0 AND P.Status=1 AND P.Type=0 AND M.IsDeleted=0 AND M.Status=1 AND EXISTS (SELECT 1 FROM SystemUserRoleMapping AS URM WHERE URM.SystemUserUUID={0} AND URM.SystemRoleUUID=RPM.SystemRoleUUID)";
            ...
            //var menus = _dbContext.SystemMenu.FromSqlRaw(strSql, AuthContextService.CurrentUser.Guid).ToList();
            else
            {

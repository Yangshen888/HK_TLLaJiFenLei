...
export default {
  ...
  mutations: {
    ...
    setVillageGuid(state, guid) {
      state.villageGuid = guid
    },
    setStreets(state, guid) {
      state.streets = guid
    },
    ...
    setDepartmentGuid(state, guid) {
      state.departmentGuid = guid
    },
      ...
      return new Promise((resolve, reject) => {
        try {
          getUserInfo(state.token).then(res => {
            ...
            commit('setVillageGuid', data.user_vuid)
            commit('setStreets', data.user_streets)
            ...
            commit("setDepartmentGuid", data.user_departmentGuid);

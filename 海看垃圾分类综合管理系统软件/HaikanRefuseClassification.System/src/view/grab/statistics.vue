...
export default {
      ...
      stores: {
        car: {
          ...
          columns: [
            ...
            { title: "状态",minWidth: 70,  key: " "},
            { title: "1月",minWidth: 65,  key: "one"},
            { title: "2月",minWidth: 65,  key: "two" },
            { title: "3月",minWidth: 65,  key: "three" },
            { title: "4月",minWidth: 65,  key: "four" },
            { title: "5月",minWidth: 65,  key: "five" },
            { title: "6月",minWidth: 65,  key: "six" },
            { title: "7月",minWidth: 65,  key: "seven" },
            { title: "8月",minWidth: 65,  key: "eight" },
            { title: "9月",minWidth: 65,  key: "ning" },
            { title: "10月",minWidth: 65,  key: "ten" },
            { title: "11月",minWidth: 65,  key: "eleven" },
            { title: "12月",minWidth: 65,  key: "twelve" },
            { title: "平均每月易腐垃圾占比",minWidth: 160,  key: "ave" },                        
          ],
          data: [],
          data1: [],
          vname:"",
  ...
  methods: {
    ...
    loadCarDispatchList() {
      ...
      getData3(this.stores.car.query).then(res => {
